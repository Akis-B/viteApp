...
const App: React.FC = () => {
    const [textColor, setTextColor] = useState('#1AB832');
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            const threshold = 200; // When to switch from green to red (reduced for earlier transition)

            if (scrollY > threshold) {
                setTextColor('#FF0000'); // Red
            } else {
                setTextColor('#1AB832'); // Green
            }
        };
    ...
    useEffect(() => {
        const updateMargin = () => {
            if (backgroundContentRef.current) {
                ...
                setRectangleMargin(height + 100); // Add 100px extra space
            }
        };
    ...
    return (
        <div>
            <header className="banner">
                <h1>VOLATILITY EXPLAINED</h1>
            </header>
            <div className="background-content" ref={backgroundContentRef}>
                <div className="hero-section">
                    <div className="hero-text" style={{ color: textColor }}>
                        <p>The <em>Market</em></p>
                        <p>is <em>always</em> up</p>
                        <p>and down</p>
                    </div>
            ...
            <div className="content-rectangle" style={{ marginTop: `${rectangleMargin}px` }}>
